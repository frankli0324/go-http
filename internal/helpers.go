...
func (c *Client) UseCoreDialer(set func(*CoreDialer) Dialer) (ok bool) {
...
func (c *Client) DisableH2() (ok bool) {
	c.UseCoreDialer(func(d *CoreDialer) Dialer {
...
func (c *Client) UseGetProxy(getProxy func(ctx context.Context, r *model.Request) (string, error)) (ok bool) {
	return c.UseCoreDialer(func(d *CoreDialer) Dialer {
		d.GetProxy = getProxy
		return d
	})
}
